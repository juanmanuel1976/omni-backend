const TRANSLATIONS = {
  es: {
    ...
    'improve.toggle': '¿Ya tenés una respuesta de otra IA? Mejorala con Crisalia',
    'improve.hint': 'Pegá la respuesta que recibiste de ChatGPT, Gemini u otra IA. Crisalia la somete al debate multi-modelo y devuelve una versión sustancialmente mejorada.',
    'improve.placeholder': 'Pegá aquí la respuesta existente de la otra IA...',
  ...
  en: {
    ...
    'improve.toggle': 'Already have an AI response? Improve it with Crisalia',
    'improve.hint': 'Paste the response you received from ChatGPT, Gemini, or any other AI. Crisalia subjects it to multi-model debate and returns a substantially improved version.',
    'improve.placeholder': 'Paste the existing AI response here...',
