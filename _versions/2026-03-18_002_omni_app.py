    ...
    try:
        async with httpx.AsyncClient(timeout=timeout) as client:
            if model_name == "gemini":
                ...
                asyncio.create_task(costs_tracker.log_cost("gemini", endpoint, usage.get("promptTokenCount", 0), usage.get("candidatesTokenCount", 0)))
                ...
                asyncio.create_task(costs_tracker.log_cost("deepseek", endpoint, usage.get("prompt_tokens", 0), usage.get("completion_tokens", 0)))
                ...
                asyncio.create_task(costs_tracker.log_cost("claude", endpoint, msg.usage.input_tokens, msg.usage.output_tokens))
